...
if selected_section == "Statistics":
    ...
    # Calculate the number of people using social media for less than 2 hours
    social_media_less_than_2_hours = random_sample[random_sample['time_spent'] < 2]
    num_social_media_less_than_2_hours = len(social_media_less_than_2_hours)

    # Calculate the probability
    total_people = len(random_sample)
    probability_less_than_2_hours = num_social_media_less_than_2_hours / total_people
    ...
    # Calculate the number of people using social media for over 5 hours
    ...
    probability_over_5_hours = num_social_media_over_5_hours / total_people_100
